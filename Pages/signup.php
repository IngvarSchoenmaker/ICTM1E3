...
<form action="signup.inc.php" method="post" class="form-3">
    ...
    <legend style="border-radius: 20px; margin-left: 450px">accountinformatie</legend>
        ...
        <input type="text" name="Voornaam" required <?php if(isset($_GET['2'])) {if (!empty($_GET['2'])) {echo 'value="' . $_GET['2'] . '"';}else{echo 'placeholder="gebruikersnaam"';}}else{echo 'placeholder="gebruikersnaam"';}?> >
        </p>
        <p class="clearfix">
            <label for="Tussenvoegsel" style="margin-right: 19px; margin-left: 400px">Tussenvoegsels:</label>
            <input type="text" name="Tussenvoegsel" <?php print("placeholder=tussenvoegsel");?>>
        </p>
        <p class="clearfix">
        ...
        <p class="clearfix">
            ...
            <input type="text" name="Emailadres" required <?php if (isset($_GET['5'])) {if (!empty($_GET['5'])) {echo 'value="' . $_GET['5'] . '"';}else{echo 'placeholder="emailadres"';}}else{echo 'placeholder="emailadres"';} ?> > <br>
        </p>
        <p class="clearfix">
...
<!-- hier staan gegevens voor factuuradres-->
    ...
    <legend style="margin-left: 450px">Factuuradres</legend>
        ...
        <b style="margin-right: 89px; margin-left: 400px"">land:</b><input type="text" name="Land" required><br><br>
    </fieldset>
    </div>
    <br>
    <br>
